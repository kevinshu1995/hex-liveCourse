...
var clean = require('gulp-clean'); //載入 gulp-pug

gulp.task('pug', () => {           //新增一任務 'pug'
  return gulp
    .src(['./source/*.pug', '!./source/layout.pug'])  // 任務的來源檔案位於 source 的所有 .pug檔案
    .pipe(pug({
...
gulp.task('watch', () => {
  gulp.watch(['./source/*.pug', '!./source/layout.pug'], gulp.series('pug'));
});
